...
async function main() {
  ...
  // const pauser = await ethers.getSigner(process.env.PAUSER_ADDR!);
  // const minter = await ethers.getSigner(process.env.MINTER_ADDR!);
  // const tokenManager = await ethers.getSigner(process.env.TOKENMANAGER_ADDR!);
  // const upgrader = await ethers.getSigner(process.env.UPGRADER_ADDR!);
