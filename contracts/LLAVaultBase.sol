    ...
    LLAVaultAuth
{
    ...
    /**
     * @notice Thrown when the provided amount is invalid (e.g., zero or negative).
     * @param _amount The invalid amount that was provided.
     */
    ...
    /**
     * @notice Thrown when the caller is not the designated multi-signature address.
     * @param _address The address that attempted the unauthorized action.
     */
    error InvalidMultisigAddress(address _address);

    /**
     * @notice Thrown when the provided token is not supported by the vault.
     * @param _token The address of the unsupported token.
     */
    error UnsupportedToken(address _token);

    /**
     * @notice Thrown when attempting to add a token that is already supported.
     * @param _token The address of the token that is already supported.
     */
